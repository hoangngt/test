...
<?php endif; ?>
			...
			<header class="title">				
				...
				<a href="<?php echo esc_url( add_query_arg('address', 'billing', get_permalink(woocommerce_get_page_id('edit_address'))) ); ?>" class="edit address_edit"><?php _e('Edit', 'woocommerce'); ?></a>	
			</header>
			<address>
				<?php
					$address = array(
...
<?php if (get_option('woocommerce_ship_to_billing_address_only')=='no') : ?>
		...
		<div class="col-2">
			...
			<header class="title">
				...
				<a href="<?php echo esc_url( add_query_arg('address', 'shipping', get_permalink(woocommerce_get_page_id('edit_address'))) ); ?>" class="edit address_edit"><?php _e('Edit', 'woocommerce'); ?></a>
			</header>
			<address>
				<?php
					$address = array(
