...
<h2 class="related_products_title order_confirmed"><?php _e('Available downloads', 'woocommerce'); ?></h2>
...
<h2 class="related_products_title order_confirmed"><?php _e('Recent Orders', 'woocommerce'); ?></h2>
<?php woocommerce_get_template('myaccount/my-orders.php', array( 'recent_orders' => $recent_orders )); ?>

<br class="clear" />
<h2 class="related_products_title order_confirmed"><?php _e('My Address', 'woocommerce'); ?></h2>	
