...
<li class="single-item <?php 
	...
	<span class="title"><a href="<?php echo get_term_link( $category->slug, 'product_cat' ); ?>">
	...
	<div class="list-item-image"><a href="<?php echo get_term_link( $category->slug, 'product_cat' ); ?>">
