...
?>
<h2 class="related_products_title order_confirmed"><?php _e('Order Details', 'woocommerce'); ?></h2>
<div class="clear"></div>
...
<header>
	<h2 class="related_products_title order_confirmed"><?php _e('Customer details', 'woocommerce'); ?></h2>
</header>
<dl class="customer_details">
<?php
	if ($order->billing_email) echo '<dt class="float-left">'.__('Email:', 'woocommerce').'</dt><dd class="float-left">'.$order->billing_email.'</dd>';
	echo '<div class="clear"></div>';
	if ($order->billing_phone) echo '<dt class="float-left">'.__('Telephone:', 'woocommerce').'</dt><dd class="float-left">'.$order->billing_phone.'</dd>';
?>
</dl>
<div class="clear"></div>
