...
if (!class_exists('MultiPostThumbnails')) {
	...
	class MultiPostThumbnails {
		...
		public function enqueue_admin_scripts() {
			$template_url = THEME_DIR . '/functions/thumbnails/multi-post-thumbnails-admin.js';
		 ...
		 */
		public static function the_post_thumbnail($post_type, $thumb_id, $post_id = null, $size = 'thumbnail-large', $attr = '', $link_to_original = false) {
